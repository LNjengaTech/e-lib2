                        ...
                        <div x-show="showDeleteBookModal" class="fixed inset-0 z-50 overflow-y-auto"
                            ...
                            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                ...
                                <div x-show="showDeleteBookModal" x-transition:enter="ease-out duration-300"
                                            ...
                                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                ...
                                                <div class="mt-2">
                                                    <p class="text-sm text-gray-500">
                                                        Are you sure you want to delete the book "<span x-text="currentBook ? currentBook.title : ''" class="font-semibold"></span>"? This action cannot be undone.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                        <form x-bind:action="currentBook ? `/admin/books/${currentBook.id}` : '#'" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
